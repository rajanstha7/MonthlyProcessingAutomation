...
//        driver.findElement(By.xpath("//span[@id='dropdownMenuButton']//img//following-sibling::span[contains(text(),'Quick')]")).click();
           ...
           // driver.findElement(By.xpath("//span[@id='dropdownMenuButton']//img")).click();
            ...
            //select Inpatient from quick links
            driver.findElement(By.xpath("//a[@class='dropdown-item'][contains(text(),'Inpatient')]")).click();
            WebDriverWait waittill = new WebDriverWait(driver, 25);
            waittill.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//ul[@class='nav nav-pills tabs-wrapper']//a[@class='nav-link inactive'][contains(text(),'Utilization')]")));
        ...
        //    js.executeScript("window.scrollBy(0,200)");
            ...
            driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
            //WebDriverWait waitutil = new WebDriverWait(driver, 30);
           // waitutil.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@class='nav-link active'][contains(text(),'Utilization')]")));
            //driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
            // js.executeScript("window.scrollBy(0,200)");
          //  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
          //  driver.findElement(By.xpath("//a[@class='nav-link active'][contains(text(),'Utilization')]")).click();
            js.executeScript("window.scrollBy(0,250)");

           // WebDriverWait waitspend = new WebDriverWait(driver, 15);
           // waitspend.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='disease-item er-box']//a[@class='nav-link inactive'][contains(text(),'Spend')]")));
            //driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
